    ...
    <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4 mx-4">
        <Box class="md:col-span-7 flex items-center w-full">
            <div v-if="listing.images.length" class="grid grid-cols-2 gap-1">
                <img v-for="image in listing.images" :key="image.id" :src="image.src" :alt="image.filename" class="rounded-md object-cover" />
            </div>
        ...
        <div class="md:col-span-5 flex flex-col gap-4">
            <Box>
                ...
                <Price :price="listing.price" class="text-2xl font-bold text-indigo-600 dark:text-indigo-300" />
            ...
            <Box>
                ...
                <div>
                    ...
                    <div class="text-gray-600 dark:text-gray-300 mt-2">
                        ...
                        <Price :price="monthlyPayment" class="text-xl font-semibold text-indigo-600 dark:text-indigo-300" />
                    </div>
