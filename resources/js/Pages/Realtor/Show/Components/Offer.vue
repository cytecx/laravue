<template>
  <Box>
    ...
    <section class="flex items-center justify-between">
      ...
      <div>
        <Link v-if="!isSold" :href="route('realtor.offer.accept', offer.id)" class="btn-outline text-xs font-medium cursor-pointer" as="button" method="put">Accept</Link>
      </div>
    </section>
  </Box>
</template>
...
const madeOn = computed(() => new Date(props.offer.created_at).toLocaleString('ms-MY'))
</script>